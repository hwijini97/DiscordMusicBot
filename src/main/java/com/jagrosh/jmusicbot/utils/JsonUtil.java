...
public class JsonUtil {
    ...
    public static <T> T fromJson(String string, Class<T> valueType) throws JsonMappingException, JsonProcessingException {
        if (string == null) {
            return null;
        }
    ...
    public static <T> T fromJson(String string, TypeReference<?> typeReference) throws JsonMappingException, JsonProcessingException {
        if (string == null) {
            return null;
        }
